'''
    ...
    Data: 13/05/2024
    Descrição: Classe para treinamento do modelo customizado do Yolo V7.
'''
...
class YoloV7():
    ...
    def configYoloV7(self):
        '''
        
        '''
        os.system('')
    
    def trainYoloV7(self):
        '''
            Function trainYoloV7
            Chama a função para treinamento do Yolo V7.
            ...
            :return: retorna o modelo do Yolo V7 treinado com o dataset customizado.
        '''
        os.system('python train.py --batch 16 --epochs {self.epochs} --data {self.dataset} --weights {self.yoloVersion} --device 0')
    ...
    def plotMC(self):
        '''
            ...
            :return: retorna a imagem da matriz de confusão do Yolo V7 treinado com o dataset customizado.
        '''
    ...
    def plotResults(self):
        '''
            ...
            :return: retorna a imagem dos resultados do Yolo V7 treinado com o dataset customizado.
        '''
    ...
    def plotVal(self):
        '''
            ...
            :return: retorna a imagem da ValBatch do Yolo V7 treinado com o dataset customizado.
        '''
    ...
    def predictModel(self):
        '''
            ...
            :return: retorna a quantidade de detecções, boundbox e o tempo para a detecção com Yolo V7 treinado com o dataset customizado.
        '''
        os.system('!python detect.py --weights {self.model} --conf {self.conf} --source {self.datasetTest}')